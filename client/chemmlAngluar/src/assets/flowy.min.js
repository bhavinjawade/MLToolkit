var flowy = function(canvas, grab, release, snapping, rearrange, spacing_x, spacing_y) {
    ...
    flowy.load = function() {
        ...
        function snap(drag, i, blocko) {
            ...
            if (arrowx < 0) {
                canvas_div.innerHTML += '<div data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" class="arrowblock"><input id = "' + parentBlock.id + "~"+ childBlock.id + '" type="hidden" class="arrowid" value="' + drag.querySelector(".blockid").value + '"><svg data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" preserveaspectratio="none" fill="none" xmlns="http://www.w3.org/2000/svg"><path data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" d="M' + (blocks.filter(a => a.id == blocko[i])[0].x - arrowhelp.x + 5) + ' 0L' + (blocks.filter(a => a.id == blocko[i])[0].x - arrowhelp.x + 5) + ' ' + (paddingy / 2) + 'L5 ' + (paddingy / 2) + 'L5 ' + arrowy + '" class="arrow_svg" stroke="#C5CCD0" stroke-width="2px"/><path d="M0 ' + (arrowy - 5) + 'H10L5 ' + arrowy + 'L0 ' + (arrowy - 5) + 'Z" class="arrow_pointer_svg" fill="#C5CCD0"/></svg></div>';
                ...
                canvas_div.innerHTML += '<div data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" class="arrowblock"><input id = "' + parentBlock.id + "~"+ childBlock.id + '" type="hidden" class="arrowid" value="' + drag.querySelector(".blockid").value + '"><svg data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" preserveaspectratio="none" fill="none" xmlns="http://www.w3.org/2000/svg"><path data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" d="M20 0L20 ' + (paddingy / 2) + 'L' + (arrowx) + ' ' + (paddingy / 2) + 'L' + arrowx + ' ' + arrowy + '" class="arrow_svg" stroke="#C5CCD0" stroke-width="2px"/><path d="M' + (arrowx - 5) + ' ' + (arrowy - 5) + 'H' + (arrowx + 5) + 'L' + arrowx + ' ' + arrowy + 'L' + (arrowx - 5) + ' ' + (arrowy - 5) + 'Z" class="arrow_pointer_svg" fill="#C5CCD0"/></svg></div>';
            ...
            for (var z = 0; z < result.length; z++) {
                ...
                for (var w = 0; w < blocks.filter(id => id.parent == result[z]).length; w++) {
                    ...
                    if (arrowx < 0) {
                        ...
                        document.querySelector('.arrowid[value="' + children.id + '"]').parentNode.innerHTML = '<input id = "' + parentBlock.id + "~"+ childBlock.id + '" type="hidden" class="arrowid" value="' + children.id + '"><svg preserveaspectratio="none" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M' + (blocks.filter(id => id.id == children.parent)[0].x - arrowhelp.x + 5) + ' 0L' + (blocks.filter(id => id.id == children.parent)[0].x - arrowhelp.x + 5) + ' ' + (paddingy / 2) + 'L5 ' + (paddingy / 2) + 'L5 ' + arrowy + '" class="arrow_svg" stroke="#C5CCD0" stroke-width="2px"/><path d="M0 ' + (arrowy - 5) + 'H10L5 ' + arrowy + 'L0 ' + (arrowy - 5) + 'Z" class="arrow_pointer_svg" fill="#C5CCD0"/></svg>';
                    } else {
                        ...
                        document.querySelector('.arrowid[value="' + children.id + '"]').parentNode.innerHTML = '<input id = "' + parentBlock.id + "~"+ childBlock.id + '" type="hidden" class="arrowid" value="' + children.id + '"><svg preserveaspectratio="none" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20 0L20 ' + (paddingy / 2) + 'L' + (arrowx) + ' ' + (paddingy / 2) + 'L' + arrowx + ' ' + arrowy + '" class="arrow_svg" stroke="#C5CCD0" stroke-width="2px"/><path d="M' + (arrowx - 5) + ' ' + (arrowy - 5) + 'H' + (arrowx + 5) + 'L' + arrowx + ' ' + arrowy + 'L' + (arrowx - 5) + ' ' + (arrowy - 5) + 'Z" class="arrow_pointer_svg" fill="#C5CCD0"/></svg>';
                    }
                }
            }
        }
