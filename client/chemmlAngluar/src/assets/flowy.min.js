var flowy = function(canvas, grab, release, arrowClicking, snapping, rearrange, spacing_x, spacing_y) {
    ...
    flowy.load = function() {
        ...
        var blockArrowParent;
        var blockArrowChild;
        var creatingArrowBegin = 0;
        ...
        flowy.import_graph = function(output) { 
...
//                rearrangeMe();
        ...
        flowy.beginDrag = function(event) {
            ...
            if (event.which != 3 && event.target.closest(".create-flowy")) {
                ...
                console.log("LEFT, TOP",drag.style.left, drag.style.top);
            }
        }
        ...
        function deleteArrow(child, i, parent){
            id = 'arrowDiv_' + parent.id + '~'+ child.id
            console.log(id);
        ...
        flowy.endDrag = function(event) {
            if (event.which != 3 && (active || rearrange)) {
                ...
                if (parseInt(drag.querySelector(".blockid").value) === 0 && rearrange) {
                    drag.classList.remove("dragging");
                    console.log("DRAGGING ROOT NODE");
                    rearrange = false;
                    ...
                    allCustomArrows = document.querySelectorAll(".arrowid[value*='~']");
                    for(var i = 0; i < allCustomArrows.length; i++){
                        // const custonArrow = allCustomArrows[i].parentNode;

                        
                        // console.log(custonArrow);
                        // custonArrow.style.left = (custonArrow.getBoundingClientRect().left + window.scrollX) - (canvas_div.getBoundingClientRect().left + window.scrollX) + canvas_div.scrollLeft - 1 + "px";
                        // custonArrow.style.top = (custonArrow.getBoundingClientRect().top + window.scrollY) - (canvas_div.getBoundingClientRect().top + canvas_div.scrollTop) - 1 + "px";
                        // canvas_div.appendChild(custonArrow);
                ...
                for(var i = 0; i < newArrowDictionary.length; i++){
                    arrow = newArrowDictionary[i];
                    console.log(arrow)
                    deleteArrow(arrow[0], i, arrow[1])
                    console.log("Deleteing Arrow===>", arrow[0], arrow[1])
                    createArrow(arrow[0], 1, arrow[1])
                }
            }
        }
        ...
        function snap(drag, i, blocko) {
            console.log(drag, i, blocko, document.querySelector(".blockid[value='" + blocko[i] + "']").parentNode);
            parentBlock = document.querySelector(".blockid[value='" + blocko[i] + "']").parentNode;
            childBlock = drag;
            ...
            if (arrowx < 0) {
                canvas_div.innerHTML += '<div data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" class="arrowblock"><input type="hidden" class="arrowid" value="' + drag.querySelector(".blockid").value + '"><svg data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" preserveaspectratio="none" fill="none" xmlns="http://www.w3.org/2000/svg"><path id = "arrow_' + parentBlock.id + "~"+ childBlock.id + '"  onclick = "arrowClick('+parentBlock.id+','+childBlock.id+');" data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" d="M' + (blocks.filter(a => a.id == blocko[i])[0].x - arrowhelp.x + 5) + ' 0L' + (blocks.filter(a => a.id == blocko[i])[0].x - arrowhelp.x + 5) + ' ' + (paddingy / 2) + 'L5 ' + (paddingy / 2) + 'L5 ' + arrowy + '" class="arrow_svg" stroke="#C5CCD0" stroke-width="2px"/><path d="M0 ' + (arrowy - 5) + 'H10L5 ' + arrowy + 'L0 ' + (arrowy - 5) + 'Z" class="arrow_pointer_svg" fill="#C5CCD0"/></svg></div>';
                ...
                canvas_div.innerHTML += '<div data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" class="arrowblock"><input type="hidden" class="arrowid" value="' + drag.querySelector(".blockid").value + '"><svg data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" preserveaspectratio="none" fill="none" xmlns="http://www.w3.org/2000/svg"><path id = "arrow_' + parentBlock.id + "~"+ childBlock.id + '"  onclick = "arrowClick('+parentBlock.id+','+childBlock.id+');" data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" d="M20 0L20 ' + (paddingy / 2) + 'L' + (arrowx) + ' ' + (paddingy / 2) + 'L' + arrowx + ' ' + arrowy + '" class="arrow_svg" stroke="#C5CCD0" stroke-width="2px"/><path data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" d="M' + (arrowx - 5) + ' ' + (arrowy - 5) + 'H' + (arrowx + 5) + 'L' + arrowx + ' ' + arrowy + 'L' + (arrowx - 5) + ' ' + (arrowy - 5) + 'Z" class="arrow_pointer_svg" fill="#C5CCD0"/></svg></div>';
        ...
        function createArrow(child, i, parent){
            console.log(child, i, parent);
            child = document.getElementById(child.id);
            parent = document.getElementById(parent.id);
            if(i == 0){
                newArrowDictionary.push([child, parent])
            }
            else{
                console.log("Replacing with New Arrow");
            }
            child_id = child.querySelector(".blockid").value;
            parent_id = parent.querySelector(".blockid").value;

            console.log(blocks, parent_id, child_id);
             
            start_point_y = parseInt(parent.style.top) + (blocks.filter(a => a.id == parent_id)[0].height / 2);
            start_point_x = parseInt(parent.style.left) + (blocks.filter(a => a.id == parent_id)[0].width / 2);

            end_point_y = parseInt(child.style.top) + (blocks.filter(a => a.id == child_id)[0].height / 2);
            end_point_x = parseInt(child.style.left) + (blocks.filter(a => a.id == child_id)[0].width / 2);

            if(end_point_y <= start_point_y){
                rel_endpoint_y = end_point_y - start_point_y;
                rel_endpoint_x = end_point_x - start_point_x;
                
                parent_height = blocks.filter(id => id.id == parent_id)[0].height;
                child_height = blocks.filter(id => id.id == child_id)[0].height;

                var arrowy = rel_endpoint_y - child_height / 2;

                newArrow = '<div  id="arrowDiv_' + parent.id + "~"+ child.id + '" data-parent = "' + parent.id + '" data-child = "' + child.id + '" \
                class="arrowblock"><input type="hidden" class="arrowid" value="' + parent_id + '~' + child_id + '"> \
                <svg data-parent = "' + parent.id + '" data-child = "' + child.id + '" preserveaspectratio="none" fill="none" \
                xmlns="http://www.w3.org/2000/svg"><path id = "arrow_' + parent.id + "~"+ child.id + '"  \
                onclick = "arrowClick('+parent.id+','+child.id+');" data-parent = "' + parent.id + '" \
                data-child = "' + child.id + 
                
                '" d="M 0 0 L 0 ' + (parent_height/2 + 40) +  'L ' + Math.sign(rel_endpoint_x) * (Math.abs(rel_endpoint_x / 2) - 20) + ' ' + (parent_height/2 + 40) + ' L ' + Math.sign(rel_endpoint_x) * (Math.abs(rel_endpoint_x / 2) + 20) + ' ' + (rel_endpoint_y - child_height/2 - 40) + ' L ' + rel_endpoint_x + ' ' + (rel_endpoint_y - child_height/2 - 40) + ' L ' + rel_endpoint_x + ' ' + rel_endpoint_y + '" class="arrow_svg" stroke="#C5CCD0" stroke-width="2px"/> ' + 
                
                ' <path d="M ' + (rel_endpoint_x - 5) + ' ' + (arrowy - 5) + ' H ' + (rel_endpoint_x + 5) + ' L ' + rel_endpoint_x + ' ' + arrowy 
                + 'L ' + (rel_endpoint_x - 5) + ' ' + (arrowy - 5) + 'Z" class="arrow_pointer_svg" fill="#C5CCD0"/></svg></div>';
            }
                ...
                xmlns="http://www.w3.org/2000/svg"><path id = "arrow_' + parent.id + "~"+ child.id + '"  \
                onclick = "arrowClick('+parent.id+','+child.id+');" data-parent = "' + parent.id + '" \
                data-child = "' + child.id + '" d="M 0 0 L 0 ' + (rel_endpoint_y - (child_height / 2) - 40) +  'L ' + rel_endpoint_x + ' ' + (rel_endpoint_y - (child_height / 2) - 40) + ' L ' + rel_endpoint_x + ' ' + rel_endpoint_y + '" class="arrow_svg" stroke="#C5CCD0" stroke-width="2px"/> ' + 
                ' <path d="M ' + (rel_endpoint_x - 5) + ' ' + (arrowy - 5) + ' H ' + (rel_endpoint_x + 5) + ' L ' + rel_endpoint_x + ' ' + arrowy 
                + 'L ' + (rel_endpoint_x - 5) + ' ' + (arrowy - 5) + 'Z" class="arrow_pointer_svg" fill="#C5CCD0"/></svg></div>';
            }

            canvas_div.innerHTML = newArrow + canvas_div.innerHTML;

            document.querySelector('.arrowid[value="' + parent_id + '~' + child_id  + '"]').parentNode.style.top = parseInt(parent.style.top) + (blocks.filter(a => a.id == parent_id)[0].height / 2) + "px";
            document.querySelector('.arrowid[value="' + parent_id + '~' + child_id  + '"]').parentNode.style.left = parseInt(parent.style.left) + (blocks.filter(a => a.id == parent_id)[0].width / 2) + "px";

        }
        
        function touchblock(event) {
            element = event.target;
            if(element.className == 'tool_footer'){
                console.log("Click on footer ARROW");
                this.blockArrowParent = element;
                this.creatingArrowBegin = 1;
            }
            if(element.className == 'tool_header' && this.creatingArrowBegin == 1){
                this.blockArrowChild = element;
                this.creatingArrowBegin = 0;
                console.log("CREATING ARROW");
                console.log(this.blockArrowParent,this.blockArrowChild);
                createArrow(this.blockArrowChild.parentElement, 0, this.blockArrowParent.parentElement);
            }
        ...
        function hasParentClass(element, classname) {
            ...
            if (element.className['baseVal'] == 'arrow_svg') {
                element = element.parentNode.parentNode;
                var childBlock = element.getAttribute('data-child');
                var parentBlock = element.getAttribute('data-parent');
                console.log(childBlock,parentBlock);
                arrowClick(childBlock, parentBlock)
            }
            }
            try{
        ...
        flowy.moveBlock = function(event) {
            ...
            if (active) {
                ...
                if(parseInt(drag.style.left, 10) < 0){
                    drag.style.left = "1px";
                }
                if(parseInt(drag.style.top, 10) < 0){
                    drag.style.top = "1px";
                }
            }
            if (active || rearrange) {
        ...
        function rearrangeMe() {
            ...
            for (var z = 0; z < result.length; z++) {
                ...
                for (var w = 0; w < blocks.filter(id => id.parent == result[z]).length; w++) {
                    ...
                    if (arrowx < 0) {
                        document.querySelector('.arrowid[value="' + children.id + '"]').parentNode.style.left = (arrowhelp.x - 5) - /* mark */ (canvas_div.getBoundingClientRect().left + window.scrollX) + "px";
                        document.querySelector('.arrowid[value="' + children.id + '"]').parentNode.innerHTML = '<input type="hidden" class="arrowid" value="' + children.id + '"><svg preserveaspectratio="none" fill="none" xmlns="http://www.w3.org/2000/svg"><path id = "arrow_' + parentBlock.id + "~"+ childBlock.id + '"  onclick = "arrowClick('+parentBlock.id+','+childBlock.id+');" data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" d="M' + (blocks.filter(id => id.id == children.parent)[0].x - arrowhelp.x + 5) + ' 0L' + (blocks.filter(id => id.id == children.parent)[0].x - arrowhelp.x + 5) + ' ' + (paddingy / 2) + 'L5 ' + (paddingy / 2) + 'L5 ' + arrowy + '" class="arrow_svg" stroke="#C5CCD0" stroke-width="2px"/><path data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" d="M0 ' + (arrowy - 5) + 'H10L5 ' + arrowy + 'L0 ' + (arrowy - 5) + 'Z" class="arrow_pointer_svg" fill="#C5CCD0"/></svg>';
                        console.log("New Arrow Dictionary 1: ", newArrowDictionary);
                    } else {
                        document.querySelector('.arrowid[value="' + children.id + '"]').parentNode.style.left = blocks.filter(id => id.id == children.parent)[0].x /* mark */ + 50 - 20 - (canvas_div.getBoundingClientRect().left + window.scrollX) + "px";
                        document.querySelector('.arrowid[value="' + children.id + '"]').parentNode.innerHTML = '<input type="hidden" class="arrowid" value="' + children.id + '"><svg preserveaspectratio="none" fill="none" xmlns="http://www.w3.org/2000/svg"><path id = "arrow_' + parentBlock.id + "~"+ childBlock.id + '"  onclick = "arrowClick('+parentBlock.id+','+childBlock.id+');" data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" d="M-30 0L-30 ' + (paddingy / 2) + 'L' + (arrowx-50) + ' ' + (paddingy / 2) + 'L' + (arrowx-50) + ' ' + arrowy + '" class="arrow_svg" stroke="#C5CCD0" stroke-width="2px"/><path data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" d="M' + (arrowx - 5 - 50) + ' ' + (arrowy - 5) + 'H' + (arrowx + 5 - 50) + 'L' + (arrowx - 50) + ' ' + arrowy + 'L' + (arrowx - 5 - 50) + ' ' + (arrowy - 5) + 'Z" class="arrow_pointer_svg" fill="#C5CCD0"/></svg>';
                        console.log("New Arrow Dictionary 1: ", newArrowDictionary);
                    }
                }
            }
    ...
    function arrowClick(child, parent) {
        console.log("clicked on arrow", child, parent);
        return arrowClicking(child, parent);
    }
