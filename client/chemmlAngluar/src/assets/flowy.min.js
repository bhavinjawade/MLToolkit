            ...
            for (var z = 0; z < result.length; z++) {
                ...
                for (var w = 0; w < blocks.filter(id => id.parent == result[z]).length; w++) {
                    ...
                    if (arrowx < 0) {
                        ...
                        document.querySelector('.arrowid[value="' + children.id + '"]').parentNode.innerHTML = '<input type="hidden" class="arrowid" value="' + children.id + '"><svg data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" preserveaspectratio="none" fill="none" xmlns="http://www.w3.org/2000/svg"><path id = "arrow_' + parentBlock.id + "~"+ childBlock.id + '"  onclick = "arrowClick('+parentBlock.id+','+childBlock.id+');" data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" d="M20 0L20 ' + (paddingy / 2) + 'L' + (arrowx) + ' ' + (paddingy / 2) + 'L' + arrowx + ' ' + arrowy + '" class="arrow_svg" stroke="#C5CCD0" stroke-width="2px"/><path data-parent = "' + parentBlock.id + '" data-child = "' + childBlock.id + '" d="M' + (arrowx - 5) + ' ' + (arrowy - 5) + 'H' + (arrowx + 5) + 'L' + arrowx + ' ' + arrowy + 'L' + (arrowx - 5) + ' ' + (arrowy - 5) + 'Z" class="arrow_pointer_svg" fill="#C5CCD0"/></svg>';
                    }
                }
            }
        }
